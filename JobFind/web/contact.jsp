        ...
        <div id="container">
            ...
            <form action="#" method="post" id="contact_form">
                <div class="name">
                    ...
                    <input type="text" placeholder="My name is" name="name" id="name_input" required="" onkeypress="return /[a-z]/i.test(event.key)">
                </div>
                <div class="email">
                    <label for="email"></label>
                    <input type="email" placeholder="My e-mail is" name="email" id="email_input" required="" pattern="^[_a-z0-9-]+(/.[_a-z0-9-]+)*@[_a-z0-9-]+(\.[_a-z0-9-]+)*(.\[a-z]{2,4})$">
                </div>
                <div class="telephone">
                    <label for="name"></label>
                    <input type="text" placeholder="My number is" name="telephone" id="telephone_input"  required="" onkeypress="return /[0-9]/i.test(event.key)">
                </div>
                <div class="subject">
